RELEASE_BRANCH = 1-20
VERSION := v$(subst -,.,$(RELEASE_BRANCH)).7
SOURCE_URL = https://distro.eks.amazonaws.com/kubernetes-${RELEASE_BRANCH}/releases/3/artifacts/kubernetes/${VERSION}/kubernetes-src.tar.gz
